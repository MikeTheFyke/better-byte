			...
			<div className="flex justify-start">
				<div>
					...
					<input
						...
						required={true}
						value={formData.step}
						className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-[620px] p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 mr-4"
						placeholder="Step"
					/>
				</div>
				<div className="w-[50px] h-[75px] flex justify-center place-items-center pt-[20px]">
